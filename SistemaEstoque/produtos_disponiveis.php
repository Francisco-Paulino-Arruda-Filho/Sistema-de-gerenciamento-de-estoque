		...
		<div class="container app">
			<div class="row">
				<div class="col-md-3 menu">
					<ul class="list-group">
						<li class="list-group-item active"><a href="#">Produtos disponíveis</a></li>
							...
							<div class="col">
								...
								<?php foreach($produtos as $indice => $produto) { ?>
										<?php if(isset($_SESSION['perfil_id'])) { ?>
											<?php if($produto->status  == 'disponivel' && $_SESSION['perfil_id'] == 1 ) { ?>
										...
										<? } ?>
										<?php if($produto->status  == 'disponivel' && ($_SESSION['perfil_id'] == 2 && $_SESSION['id_usuario'] == $produto->id_usuario)) { ?>
											<div class="row mb-3 d-flex align-items-center produto">
												<div class="col-sm-9"id="produto_<?= $produto->id_produto ?>">
													<?= $produto->nome ?>
												</div>
